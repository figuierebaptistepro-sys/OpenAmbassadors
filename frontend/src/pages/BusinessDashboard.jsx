                ...
                <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {!hasProjects && (
                        <Button onClick={() => setProjectDialogOpen(true)} size="sm" className="bg-primary hover:bg-primary-hover mt-2 text-xs">
                          <Plus className="w-4 h-4 mr-1.5" />
              ...
              <CardContent className="px-4">
                {hasProjects ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button variant="outline" size="sm" onClick={() => setProjectDialogOpen(true)} className="border-gray-200 text-xs">
                      <Plus className="w-4 h-4 mr-1.5" />
                      Nouveau projet
                    </Button>
                  </div>
